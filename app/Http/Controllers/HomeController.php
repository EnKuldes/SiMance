    ...
    public function save_daily_input(Request $request)
    {
      ...
      switch ($id_parameter) {
        ...
        case 6:
          ...
          /*$qWhere .= '(ifnull(AVG(CASE WHEN id_formulasi=16 THEN nilai ELSE NULL END), 0) +  ifnull(AVG(CASE WHEN id_formulasi=17 THEN nilai ELSE NULL END), 0) +  ifnull(AVG(CASE WHEN id_formulasi=18 THEN nilai ELSE NULL END), 0) +  ifnull(AVG(CASE WHEN id_formulasi=19 THEN nilai ELSE NULL END), 0) +  ifnull(AVG(CASE WHEN id_formulasi=20 THEN nilai ELSE NULL END), 0) +  ifnull(AVG(CASE WHEN id_formulasi=45 THEN nilai ELSE NULL END), 0) +  ifnull(AVG(CASE WHEN id_formulasi=46 THEN nilai ELSE NULL END), 0) +  ifnull(AVG(CASE WHEN id_formulasi=47 THEN nilai ELSE NULL END), 0))/(SELECT COUNT(id) AS pembagi FROM formulasis WHERE id_parameter = 6 AND is_enabled = "1" )';*/
          $qWhere .= '(ifnull(AVG(CASE WHEN id_formulasi=48 THEN nilai ELSE NULL END), 0) +  ifnull(AVG(CASE WHEN id_formulasi=49 THEN nilai ELSE NULL END), 0))/(SELECT COUNT(id) AS pembagi FROM formulasis WHERE id_parameter = 6 AND is_enabled = "1" )';
          $param_compare = '<=';
          break;
        case 7:
