         ...
         success: function(data){
          ...
          for (var i = 0; i < data.length; i++) {
            ...
            if (data[i]['paramater_id'] == 3 || data[i]['paramater_id'] == 8) {
              ...
              content += 'text-success">'+new Intl.NumberFormat().format( parseFloat(data[i]['realisasi_per_formulasi'][0]['formulasi_total']) + parseFloat(data[i]['realisasi_per_formulasi'][1]['formulasi_total']) + parseFloat(data[i]['realisasi_per_formulasi'][3]['formulasi_total']) + parseFloat(data[i]['realisasi_per_formulasi'][4]['formulasi_total']) )+'</p>';
